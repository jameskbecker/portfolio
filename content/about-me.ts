const aboutMe = `I began my web development journey **five years** ago, teaching myself to code with the goal of creating automation scripts. It was during this time that I fell in love with programming, discovering the **endless possibilities** of building digital solutions. After spending about a year as a self-taught developer, I decided to pursue a degree in **Computer Science.**
